...
! this part of boundary update should be done only if we are working with
! adaptive mesh
!
    if (maxlev .gt. 1) then

!!
!! first COPY boundaries between blocks at the same level and apply SPECIFIC
...
!!
!! then RESTRICT boundaries from blocks at higher levels
!!
!
! update boundaries direction by direction
!
...
!!
!! then COPY boundaries between blocks at the same level and apply SPECIFIC
!! boundary conditions again
!!
!
! update boundaries direction by direction
...
!!
!! then PROLONG boundaries from blocks at lower levels
!!
!
! update boundaries direction by direction
!
...
!!
!! finally COPY boundaries between blocks at the same level and apply SPECIFIC
!! boundary conditions
!!
!
! update boundaries direction by direction
